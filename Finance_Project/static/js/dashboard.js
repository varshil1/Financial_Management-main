var endpoint = $("#salesDifference").attr("data-url");
var x1=new Array(5);
var x2=new Array(5);
var i=0;
var j=0;
$(document).ready(function() {
	...
	$.ajax({
		...
		success: function(response){
			...
			// 	x1[i]=parseInt(response[x]);
			// 	i++;
			// }
			
			// for(var x in response["labels"]){
			// 	x2[j]=parseInt(response[x]);
			// 	j++;
			// }
...
(function($) {
	...
	// 'use strict';
	$(function() {
		//var YOUR_JS_LIST = "{{data|safe}}"; 
		//var data = JSON.parse("{{data}}");
		// var i=0;
		// var x1=new Array(5);
		// for(i=0;i<5;i++){
		// 	x1[i]=parseInt(YOUR_JS_LIST[i]);
		// 	//i++;
		// }
		
		
		// var temp1=["Marriage2", "New-car", "Property", "Leh-ladakh trip", "Charity"];
		// var temp2=[22, 28, 18, 20, 12];
		console.log(x1);
		console.log(x2);
		// console.log(temp1);
		// console.log(temp2);
...
// ***************************************WEEKLY STARTS************************
		var revenueChartData = {
			...
			datasets: [{
				label: 'Income',
				data: [40, 65, 70, 60, 50, 50, 70, 60, 65, 60, 55, 55],
				backgroundColor: [
						'#0ddbb9',
				],
				borderColor: [
